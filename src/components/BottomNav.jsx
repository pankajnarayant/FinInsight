...
const HomeNavIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ display: 'block' }}>
      ...
      {navItems.map((item) => {
        ...
        return (
          ...
          >
            ...
            <span style={{ fontSize: 11, lineHeight: 1, marginTop: 2 }}>{item.label}</span>
          </button>
        );
      })}
    </div>
