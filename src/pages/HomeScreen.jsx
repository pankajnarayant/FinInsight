  ...
  return (
    <PhoneContainer>
      <div style={{ display: 'flex', flexDirection: 'column', height: '100%', background: '#F5F8FC', fontSize: 14 }}>
        ...
        >
          <div>
            <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.7)' }}>{greeting},</div>
          ...
          >
            <div style={{ fontSize: 9, color: 'rgba(255,255,255,0.65)', marginBottom: 1 }}>Pre-approved</div>
            <div style={{ fontSize: 13, fontWeight: 800, color: '#fff' }}>{pre_approved_formatted}</div>
          </div>
        </div>
        ...
        <div style={{ flex: 1, overflowY: 'auto', overflowX: 'hidden' }}>
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
              <div style={{ flex: 1, paddingRight: 10 }}>
                <div style={{ fontSize: 17, fontWeight: 800, color: '#002970', lineHeight: 1.35 }}>
                  Your AI-powered
                  <br />
                  Financial Journey
                  <br />
                ...
                <div style={{ fontSize: 12, color: '#5F6B7A', marginTop: 7, lineHeight: 1.6 }}>
                  Making financial decisions simple,
                  <br />
                  personalized and understandable.
                </div>
              </div>
              <div style={{ color: '#00A8FF', flexShrink: 0, marginTop: 2 }}>
                <SparkleIcon />
              </div>
            </div>
          ...
          >
            <div style={{ flex: 1, borderRight: '1px solid #E8EFF7', paddingRight: 14, marginRight: 14 }}>
              ...
              <div style={{ fontSize: 22, fontWeight: 900, color: '#002970', lineHeight: 1 }}>{credit_score}</div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 4, marginTop: 4 }}>
                <div style={{ width: 7, height: 7, borderRadius: 999, background: '#16A34A' }} />
                <span style={{ fontSize: 10, color: '#16A34A', fontWeight: 600 }}>{credit_status}</span>
              </div>
            </div>
            <div style={{ flex: 1, borderRight: '1px solid #E8EFF7', paddingRight: 14, marginRight: 14 }}>
              ...
              <div style={{ fontSize: 10, color: '#5F6B7A', marginTop: 4 }}>{existing_emi_formatted}</div>
            </div>
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: 10, color: '#5F6B7A', marginTop: 4 }}>{existing_savings}</div>
            </div>
          </div>
          ...
          <div style={{ overflowX: 'auto', padding: '0 14px 12px', display: 'flex', gap: 8, scrollbarWidth: 'none' }}>
            {[
              { label: 'Personal Loan', purpose: 'Personal', branch: 'LOAN' },
              { label: 'Home Loan', purpose: 'Home', branch: 'LOAN' },
              { label: 'Car Loan', purpose: 'Car', branch: 'LOAN' },
              { label: 'Health Insurance', purpose: 'Health', branch: 'INSURANCE' },
              { label: 'Life Insurance', purpose: 'Life', branch: 'INSURANCE' },
              { label: 'Credit Card', purpose: 'Credit Card', branch: 'OTHER' },
              { label: 'Mutual Fund', purpose: 'Mutual Fund', branch: 'OTHER' },
              { label: 'Fixed Deposit', purpose: 'Fixed Deposit', branch: 'OTHER' },
            ].map((chip) => (
              <div
                key={chip.label}
                onClick={() => navigate('/chat', { entryBranch: chip.branch, initialPurpose: chip.purpose })}
                style={{
                  whiteSpace: 'nowrap',
                  padding: '6px 14px',
                  borderRadius: 999,
                  background: chip.branch === 'INSURANCE' ? '#F0FDF4' : '#EEF4FB',
                  border: `1px solid ${chip.branch === 'INSURANCE' ? '#BBF7D0' : '#D0E8FB'}`,
                  fontSize: 11,
                  fontWeight: 600,
                  color: chip.branch === 'INSURANCE' ? '#15803D' : '#004AAD',
                  cursor: 'pointer',
                  flexShrink: 0,
                  transition: 'all 0.15s ease',
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = chip.branch === 'INSURANCE' ? '#DCFCE7' : '#E0EEFC';
                  e.currentTarget.style.borderColor = chip.branch === 'INSURANCE' ? '#86EFAC' : '#00A8FF';
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = chip.branch === 'INSURANCE' ? '#F0FDF4' : '#EEF4FB';
                  e.currentTarget.style.borderColor = chip.branch === 'INSURANCE' ? '#BBF7D0' : '#D0E8FB';
                }}
              >
                {chip.label}
              </div>
          ...
          <div style={{ padding: '0 14px', display: 'flex', flexDirection: 'column', gap: 10 }}>
            {/* Primary card — Loan (Branch A) */}
            <div
              onClick={() => navigate('/chat', { entryBranch: 'LOAN' })}
              style={{
                background: '#fff',
                ...
                gap: 12,
                cursor: 'pointer',
                boxShadow: '0 4px 18px rgba(0,168,255,0.13)',
              }}
            >
              <div
                style={{
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: 11, color: '#5F6B7A', marginTop: 2, lineHeight: 1.4 }}>
                  Understand your options, costs and eligibility.
                </div>
              </div>
              <div style={{ color: '#00A8FF', flexShrink: 0 }}>
                <ChevronRight />
              </div>
            </div>

            {/* Insurance (INSURANCE branch — teal/green accent) */}
            <div
              onClick={() => navigate('/chat', { entryBranch: 'INSURANCE' })}
              style={{
                background: '#fff',
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontSize: 13, fontWeight: 700, color: '#15803D' }}>I need Insurance</div>
                <div style={{ fontSize: 11, color: '#5F6B7A', marginTop: 2, lineHeight: 1.4 }}>
                  Health, Life, Vehicle &amp; Term plans.
                </div>
              </div>
            ...
            {/* Other Services (Branch B) */}
            <div
              onClick={() => navigate('/chat', { entryBranch: 'OTHER' })}
              style={{
                background: '#fff',
                border: '1px solid #E3ECF5',
                borderRadius: 18,
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ fontSize: 11, color: '#5F6B7A', marginTop: 2, lineHeight: 1.4 }}>
                  Investments, credit cards and more.
                </div>
              </div>
              <div style={{ color: '#B0C4D8', flexShrink: 0 }}>
                <ChevronRight />
              </div>
            </div>
          </div>
          ...
          <div style={{ padding: '18px 14px 6px' }}>
            <button
              ...
              style={{
                ...
                border: 'none',
                cursor: 'pointer',
                boxShadow: '0 4px 18px rgba(0,168,255,0.38)',
                letterSpacing: 0.3,
                fontFamily: 'inherit',
            ...
            <div style={{ textAlign: 'center', fontSize: 11, color: '#8A9BB0', marginTop: 8 }}>
